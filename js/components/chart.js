...
const subHeaderDateEl = document.querySelector(".swap-chart-subheader-date");
const subHeaderPriceEl = document.querySelector(".swap-chart-subheader-price");
...
async function updateChart(isInverted, days = 1, interval = "hourly") {
  ...
  let data = await MarketChart.find(
    ...
    const headerTokensText = isInverted ? "BNB/CAKE" : "CAKE/BNB";
    headerTokensEl.innerText = headerTokensText;

    const subHeaderTokensText = isInverted ? "BNB/CAKE" : "CAKE/BNB";
